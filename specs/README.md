...
| 13 | [Interactive front-ends](13-web-ui/README.md) | TUI & web UI: SPA shell, JSON API, streams tree/drill-down, timeline & scrubbing (retrofit — shipped ahead of its spec, see task README) | 05, 06, 07, 08 |
...
Task 13 (TUI/web front-ends) is a leaf on 05–08, in practice built alongside/after 08; task
12's front-end sub-task (12.5) is a delta on top of it, not independent of it, despite the
numbering. Task 12 is a leaf on 05/07/08/09 — the scale pass over the shipped aggregator and
