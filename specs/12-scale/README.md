...
- [x] [12.4 Snapshot index & windowed view API](04-windowed-view-api.md) — D17.3/.4 (FR-7)
- [x] [12.5 Web UI at scale](05-scalable-web-ui.md) — virtualized tree, canvas timeline, progress (§5)
