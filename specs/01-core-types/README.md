...
- [ ] [01.1 Metadata values & field maps](01-metadata-values.md) — `Value`, `FieldMap` (FR-18)
- [ ] [01.2 Layers & stacks](02-layers-and-stacks.md) — `LayerRecord`, `PacketView` (FR-10)
- [ ] [01.3 Extraction depth](03-extraction-depth.md) — four levels + flow-key floor (FR-16)
