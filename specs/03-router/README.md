...
- [x] [03.3 Heuristic fallback](03-heuristic-fallback.md) — probe scoring + prior + determinism (FR-14)
- [x] [03.4 Gated termination](04-gated-termination.md) — the no-phantom-streams gate (FR-15)
